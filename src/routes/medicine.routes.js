...
const { cache, invalidateCachePrefix } = require("../middlewares/cache.middleware");
...
// ── Single medicine (optionally authenticated for recently-viewed tracking) ───
router.get("/:id", optionalProtect, getMedicineById);

// ── Recommendations (public) ──────────────────────────────────────────────────
router.get("/:id/recommendations", cache(120), getRecommendations);
